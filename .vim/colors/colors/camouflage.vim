      ...
      hi CursorLine     guibg=#100A09 cterm=none ctermbg=darkgray
        hi CursorColumn   guibg=#100A09 cterm=none ctermbg=darkgray
          hi MatchParen     guibg=#505050 gui=bold
            ...
            " hi Normal           guifg=#D5E285 guibg=#070100 ctermfg=red
            " gui=none
            " hi NonText          guifg=#4A4A59 gui=none
            " hi LineNr           guifg=#7E8841 guibg=#201A19
            " ctermfg=lightyellow gui=none
            " hi StatusLine       guifg=#00D2D2 guibg=#38290B ctermfg=cyan
            " gui=italic
            " hi StatusLineNC     guifg=#00D2D2 guibg=#2F2928 ctermfg=cyan
            " gui=none
            " hi VertSplit        guifg=#00D2D2 guibg=#201A19 ctermfg=cyan
            " gui=none
            " hi Folded           guifg=#00D2D2 guibg=#070100 ctermfg=cyan
            " gui=none
            " hi FoldColumn       guifg=#00D2D2 guibg=#070100 ctermfg=cyan
            " gui=none
            ...
            " hi Type guifg=#A5A3:00 gui=none ctermfg=darkyellow
            "
            " " Special for Ruby
